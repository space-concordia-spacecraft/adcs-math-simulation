...
#include "old/SimplifiedGeneralPerturbations.h"
...
namespace adcs::sgp {
	...
	*    vallado, crawford, hujsak, kelso  2006
    ...
    {
        /* --------------------- local variables ------------------------ */
        const double twopi = 2.0 * CONST_PI;
	...
	*    vallado, crawford, hujsak, kelso  2006
            ...
            )
    {
        ...
        if ((omeosq >= 0.0) || (satrec.no_unkozai >= 0.0))
        {
            ...
            /* --------------- deep space initialization ------------- */
            if ((2 * CONST_PI / satrec.no_unkozai) >= 225.0)
            {
                satrec.method = 'd';
                satrec.isimp = 1;
                tc = 0.0;
    ...
    *    vallado, crawford, hujsak, kelso  2006
    ...
    {
        const double deg2rad = CONST_PI / 180.0;         //   0.0174532925199433
        const double xpdotp = 1440.0 / (2.0 * CONST_PI);  // 229.1831180523293
	...
	*    vallado, crawford, hujsak, kelso  2006
    ...
    bool sgp4(elsetrec satrec, double timeSinceEpoch, vec3 position, vec3 velocity){
        ...
        else
        {
            ...
            position.x = (mrt * ux)* satrec.radiusearthkm;
            position.y = (mrt * uy)* satrec.radiusearthkm;
            position.z = (mrt * uz)* satrec.radiusearthkm;
